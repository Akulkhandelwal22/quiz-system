...
<body>
    ...
    <h2 class="text-2xl text-center text-green-800 mb-6 font-bold">Total Questions {{Session('currentQuiz')['totalMcq']}}</h2>
    <h2 class="text-xl text-center text-green-800 mb-6 font-bold ">{{session('currentQuiz')['currentMcq']}}  of {{session('currentQuiz')['totalMcq']}}</h2>
    <div class="mt-2 p-4 bg-white shadow-2xl rounded-xl w-140">
        ...
        <form class="space-y-3" action="/submit-next/{{$mcqData->id}}" method="get">
            @csrf
            ...
            <label for="Option_1" class="flex border p-3 mt-2 rounded-2xl shadow-2xl cursor-pointer hover:bg-blue-50">
                <input id="Option_1" class="form-radio text-blue-600" type="radio" value="a" name="option">
            ...
            <label for="Option_2" class="flex border p-3 mt-2 rounded-2xl shadow-2xl cursor-pointer hover:bg-blue-50">
                <input id="Option_2" class="form-radio text-blue-600" type="radio" value="b" name="option">
            ...
            <label for="Option_3" class="flex border p-3 mt-2 rounded-2xl shadow-2xl cursor-pointer hover:bg-blue-50">
                <input id="Option_3" class="form-radio text-blue-600" type="radio" value="c" name="option">
            ...
            <label for="Option_4" class="flex border p-3 mt-2 rounded-2xl shadow-2xl cursor-pointer hover:bg-blue-50">
                <input id="Option_4" class="form-radio text-blue-600" type="radio" value="d" name="option">
                <span class="text-green-900 pl-2">{{$mcqData->d}}</span>        
            </label>
            <button type="submit" class="w-full bg-blue-500 rounded-xl px-4 py-2 text-white">Submit And Next</button>
        </form>   
    </div>
