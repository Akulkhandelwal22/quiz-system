...
<body>
  <x-user-navbar></x-user-navbar>
    ...
    <div class="w-200">
        @if ($correctAnswers*100/count($resultData))
        <a class="text-green-500 font-bold block" href="/certificate">View And Download Certificate</a>
        @endif
        <h1 class="text-2xl text-green-900 text-center my-5">{{$correctAnswers}} out of {{count($resultData)}} Correct</h1>
        ...
        <li class="p-2 font-bold">
            ...
            <li class="even:bg-gray-200 p-2">
                <ul class="flex justify-between">
                    ...
                    @if($item->is_correct)
                    <li class="w-70 text-green-700 ">Correct</li>
                    @else
                    <li class="w-70 text-red-700 ">Incorrect</li>
                    @endif
                </ul>
            </li>
            @endforeach
